package ro.trc.leave.repository;

import ro.trc.leave.LeaveTestApp;
import ro.trc.leave.config.Constants;
import ro.trc.leave.config.TestSecurityConfiguration;
import ro.trc.leave.config.audit.AuditEventConverter;
import ro.trc.leave.domain.PersistentAuditEvent;
...
import static ro.trc.leave.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
